...
# ! add index
def plot_one_box(img, coord, index=None,label=None, score=None, color=None, line_thickness=None):
    ...
    if label:
        ...
        cv2.putText(img, 'Index:{}, {}: {:.0%}'.format(index, label, score), (c1[0], c1[1] - 2), 0, float(tl) / 3, [0, 0, 0],
